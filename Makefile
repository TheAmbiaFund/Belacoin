#############################################################################
# Makefile for building: BellaCoin-qt
# Generated by qmake (2.01a) (Qt 4.8.2) on: Tue Apr 8 03:00:13 2014
# Project:  BellaCoin-qt.pro
# Template: app
# Command: /usr/bin/qmake USE_UPNP=- -o Makefile BellaCoin-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu /home/belladev/devbench/bellacoin/src/leveldb/libleveldb.a /home/belladev/devbench/bellacoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
SOURCES       = src/qt/bitcoin.cpp \
		...
		build/moc_voucherpage.cpp \
		build/moc_calculator.cpp \
		build/moc_tradepage.cpp \
		build/moc_poolpage.cpp \
...
OBJECTS       = build/bitcoin.o \
		...
		build/moc_voucherpage.o \
		build/moc_calculator.o \
		build/moc_tradepage.o \
		build/moc_poolpage.o \
...
$(TARGET): /home/belladev/devbench/bellacoin/src/leveldb/libleveldb.a /home/belladev/devbench/bellacoin/build/build.h build/ui_sendcoinsdialog.h build/ui_coincontroldialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_explorerpage.h build/ui_voucherpage.h build/ui_calculator.h build/ui_tradepage.h build/ui_poolpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: BellaCoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile BellaCoin-qt.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/BellaCoin-qt1.0.2.0 || $(MKDIR) build/BellaCoin-qt1.0.2.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/BellaCoin-qt1.0.2.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/BellaCoin-qt1.0.2.0/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/coincontrol.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/qt/walletview.h src/qt/walletstack.h src/qt/walletframe.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/explorerpage.h src/qt/voucherpage.h src/qt/calculator.h src/qt/tradepage.h src/qt/poolpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/scrypt.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h src/limitedmap.h src/qt/macnotificationhandler.h src/qt/splashscreen.h build/BellaCoin-qt1.0.2.0/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/BellaCoin-qt1.0.2.0/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/bloom.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/qt/walletview.cpp src/qt/walletstack.cpp src/qt/walletframe.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/explorerpage.cpp src/qt/voucherpage.cpp src/qt/calculator.cpp src/qt/tradepage.cpp src/qt/poolpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/scrypt.cpp src/noui.cpp src/leveldb.cpp src/txdb.cpp src/qt/splashscreen.cpp build/BellaCoin-qt1.0.2.0/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/coincontroldialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/explorerpage.ui src/qt/forms/voucherpage.ui src/qt/forms/calculator.ui src/qt/forms/tradepage.ui src/qt/forms/poolpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui build/BellaCoin-qt1.0.2.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/BellaCoin-qt1.0.2.0/ && (cd `dirname build/BellaCoin-qt1.0.2.0` && $(TAR) BellaCoin-qt1.0.2.0.tar BellaCoin-qt1.0.2.0 && $(COMPRESS) BellaCoin-qt1.0.2.0.tar) && $(MOVE) `dirname build/BellaCoin-qt1.0.2.0`/BellaCoin-qt1.0.2.0.tar.gz . && $(DEL_FILE) -r build/BellaCoin-qt1.0.2.0


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/belladev/devbench/bellacoin/src/leveldb/libleveldb.a; cd /home/belladev/devbench/bellacoin/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/belladev/devbench/bellacoin/src/leveldb/libleveldb.a: FORCE
	cd /home/belladev/devbench/bellacoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/belladev/devbench/bellacoin/build/build.h: FORCE
	cd /home/belladev/devbench/bellacoin; /bin/sh share/genbuild.sh /home/belladev/devbench/bellacoin/build/build.h
...
build/moc_explorerpage.cpp: src/qt/explorerpage.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/explorerpage.h -o build/moc_explorerpage.cpp

build/moc_voucherpage.cpp: src/qt/voucherpage.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/voucherpage.h -o build/moc_voucherpage.cpp

build/moc_calculator.cpp: src/qt/calculator.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/calculator.h -o build/moc_calculator.cpp

build/moc_tradepage.cpp: src/qt/tradepage.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/tradepage.h -o build/moc_tradepage.cpp

build/moc_poolpage.cpp: src/qt/poolpage.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/poolpage.h -o build/moc_poolpage.cpp
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/calculator.png \
...
compiler_moc_source_make_all: build/overviewpage.moc build/explorerpage.moc build/voucherpage.moc build/calculator.moc build/tradepage.moc build/poolpage.moc build/rpcconsole.moc
compiler_moc_source_clean:
	-$(DEL_FILE) build/overviewpage.moc build/explorerpage.moc build/voucherpage.moc build/calculator.moc build/tradepage.moc build/poolpage.moc build/rpcconsole.moc
...
build/explorerpage.moc: src/qt/explorerpage.h \
		...
		src/qt/guiconstants.h \
		src/qt/explorerpage.cpp
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/explorerpage.cpp -o build/explorerpage.moc

build/voucherpage.moc: src/qt/voucherpage.h \
		build/ui_voucherpage.h \
		src/qt/clientmodel.h \
		src/qt/walletmodel.h \
		src/allocators.h \
		src/qt/bitcoinunits.h \
		...
		src/qt/guiconstants.h \
		src/qt/voucherpage.cpp
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/voucherpage.cpp -o build/voucherpage.moc

build/calculator.moc: src/qt/calculator.h \
		build/ui_calculator.h \
		src/qt/clientmodel.h \
		src/qt/walletmodel.h \
		src/allocators.h \
		src/qt/bitcoinunits.h \
		...
		src/qt/guiconstants.h \
		src/qt/calculator.cpp
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/calculator.cpp -o build/calculator.moc

build/tradepage.moc: src/qt/tradepage.h \
		build/ui_tradepage.h \
		src/qt/clientmodel.h \
		src/qt/walletmodel.h \
		src/allocators.h \
		src/qt/bitcoinunits.h \
		...
		src/qt/guiconstants.h \
		src/qt/tradepage.cpp
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/tradepage.cpp -o build/tradepage.moc

build/poolpage.moc: src/qt/poolpage.h \
		build/ui_poolpage.h \
		src/qt/clientmodel.h \
		src/qt/walletmodel.h \
		src/allocators.h \
		...
		src/qt/guiconstants.h \
		src/qt/poolpage.cpp
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/poolpage.cpp -o build/poolpage.moc
...
build/ui_explorerpage.h: src/qt/forms/explorerpage.ui
	/usr/bin/uic-qt4 src/qt/forms/explorerpage.ui -o build/ui_explorerpage.h

build/ui_voucherpage.h: src/qt/forms/voucherpage.ui
	/usr/bin/uic-qt4 src/qt/forms/voucherpage.ui -o build/ui_voucherpage.h

build/ui_calculator.h: src/qt/forms/calculator.ui
	/usr/bin/uic-qt4 src/qt/forms/calculator.ui -o build/ui_calculator.h

build/ui_tradepage.h: src/qt/forms/tradepage.ui
	/usr/bin/uic-qt4 src/qt/forms/tradepage.ui -o build/ui_tradepage.h

build/ui_poolpage.h: src/qt/forms/poolpage.ui
	/usr/bin/uic-qt4 src/qt/forms/poolpage.ui -o build/ui_poolpage.h
...
build/voucherpage.o: src/qt/voucherpage.cpp src/qt/voucherpage.h \
		build/ui_voucherpage.h \
		src/qt/clientmodel.h \
		src/qt/walletmodel.h \
		src/allocators.h \
		...
		src/qt/guiutil.h \
		src/qt/guiconstants.h \
		build/voucherpage.moc
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/voucherpage.o src/qt/voucherpage.cpp

build/calculator.o: src/qt/calculator.cpp src/qt/calculator.h \
		build/ui_calculator.h \
		src/qt/clientmodel.h \
		src/qt/walletmodel.h \
		src/allocators.h \
		...
		src/qt/guiutil.h \
		src/qt/guiconstants.h \
		build/calculator.moc
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/calculator.o src/qt/calculator.cpp

build/tradepage.o: src/qt/tradepage.cpp src/qt/tradepage.h \
		build/ui_tradepage.h \
		src/qt/clientmodel.h \
		src/qt/walletmodel.h \
		src/allocators.h \
		...
		src/qt/guiconstants.h \
		build/tradepage.moc
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/tradepage.o src/qt/tradepage.cpp

build/poolpage.o: src/qt/poolpage.cpp src/qt/poolpage.h \
		build/ui_poolpage.h \
		src/qt/clientmodel.h \
		src/qt/walletmodel.h \
		src/allocators.h \
		...
		src/qt/guiconstants.h \
		build/poolpage.moc
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/poolpage.o src/qt/poolpage.cpp
...
build/moc_voucherpage.o: build/moc_voucherpage.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_voucherpage.o build/moc_voucherpage.cpp

build/moc_calculator.o: build/moc_calculator.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_calculator.o build/moc_calculator.cpp

build/moc_tradepage.o: build/moc_tradepage.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_tradepage.o build/moc_tradepage.cpp

build/moc_poolpage.o: build/moc_poolpage.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_poolpage.o build/moc_poolpage.cpp
